# This project implements a generic csv file upload functionality
1. to create different types of entities based on the uploadType. Here uploadType refers to a specific entity.  
